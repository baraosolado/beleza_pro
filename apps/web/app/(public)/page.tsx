...
export default function HomePage() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-app-bg p-8">
      ...
      <div className="mt-8 flex gap-4">
        <Link
          href="/auth/login"
          className="rounded-lg bg-primary px-6 py-3 font-semibold text-white shadow-btn-primary hover:bg-primary-hover"
        >
          Entrar
        </Link>
        <Link
